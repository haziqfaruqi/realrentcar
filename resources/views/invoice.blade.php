...
<body>
    <div class="container">
        ...
        <p style="margin-bottom: 30px; font-weight: bold">You can visit any of our store locations near you, 
            present your reservation invoice (either digital or printed), complete your payment, and collect your car.</p>
        <div class="inv-header">
            <div>
                <h2 style="color: #ff9b00">DZ Empire Legacy</h2>
                <ul>
                    <li>MUHD AZIZUL </li>
                    <li>011-6530 4520</li>
                </ul>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>RM{{ $reservation->price_per_day }}</td>
                        <td>RM{{ $reservation->total_price }}</td>
                    </tr>
        ...
        <div class="inv-footer">
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <th>tax</th>
                        <td>(15%) RM{{ intval($reservation->total_price - ($reservation->total_price * 85) / 100) }}
                        </td>
                    </tr>
                    <tr>
                        <th style="color: #ff9b00">Total to pay</th>
                        <td>RM{{ $reservation->total_price - ($reservation->total_price * 85) / 100 + $reservation->total_price }}
                        </td>
                    </tr>
                </table>
            </div>
