        ...
        <div class="pt-10 mx-auto max-w-screen-xl relative">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-3 gap-8 ">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-400">
                            <li class="mb-4">
                                <a href="https://www.tiktok.com/@ceokeretasewa" class="hover:underline "
                                    target='_blank'>Tiktok</a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/dzempire_carrental/" class="hover:underline"
            ...
            <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2024 <a
                        href="https://uitm.edu.my/index.php/en/" target='_blank'
                        class="hover:underline">UiTM | FSKM</a>. All Rights Reserved.
                </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://www.tiktok.com/@ceokeretasewa" target='_blank'
                        class="text-gray-500  hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 448 512">
                            ...
                            <path
                                d="M448,209.2c-5.5,0.4-11.1,0.7-16.7,0.7c-45.1,0-84.4-24.6-105.1-61.2c-5.7-10-10.3-20.8-13.6-32.3c-3.2-10.7-5.3-21.9-6.1-33.5h-50.6v252.2c0,39-31.7,70.7-70.7,70.7c-39,0-70.7-31.7-70.7-70.7c0-38.4,30.4-69.7,68.5-70.7v-61.5c-71.8,1-130,59.3-130,132.2C73.1,444.1,138.9,510,218.2,510c79.3,0,144.8-65.7,144.8-144.8V220.9c25.1,13.3,53.5,21.1,83.6,21.1c5.6,0,11.2-0.2,16.7-0.7V209.2z" />
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/dzempire_carrental/" target='_blank'
                        class="text-gray-500  hover:text-white">
                        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
