        ...
        <div class="flex justify-between md:flex-row flex-col ">
            ...
            <div class="md:w-2/3  md:border-r border-gray-800 p-2">
                ...
                <div class=" flex items-end mt-8 ms-4">
                    ...
                    <p>
                        <span
                            class=" text-3xl font-bold text-pr-400 ms-3 me-1 border border-pr-400 p-2 rounded-md">RM{{ $car->price_per_day }}</span>
                        <span
                            class="text-lg font-medium text-red-500 line-through">RM{{ intval(($car->price_per_day * 100) / (100 - $car->reduce)) }}
                        </span>
                    </p>
                </div>
            ...
            <div class="md:w-1/3 flex flex-col justify-start items-center">
                ...
                <div class=" w-full   mt-8 ms-8">
                    <p id="total-price" class="font-car text-gray-600 text-lg ms-2">Estimated Price: <span
                            class="mx-2 font-car text-md font-medium text-gray-700 border border-pr-400 p-2 rounded-md ">RM --</span>
                    </p>
                </div>
                ...
                flatpickrElement._flatpickr.config.onChange.push(function(selectedDates, dateStr, instance) {
                    if (selectedDates.length === 2) {
                        ...
                        if (startDate && endDate && startDate <= endDate) {
                            ...
                            $('#total-price span').text('RM' + totalPrice);
                        } else {
                            $('#duration span').text('-- days');
                            $('#total-price span').text('RM --');
                        }
                    } else {
                        $('#duration span').text('-- days');
                        $('#total-price span').text('RM --');
