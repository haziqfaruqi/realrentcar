        ...
        <div class="bg-sec-100 ">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex flex-col justify-center">
                            <h3 class="font-car font-medium text-4xl">30</h3>
                    ...
                    <div
                        class="flex justify-around md:w-1/3 text-center my-4 h-16 align-middle md:border-b-0 md:border-r-2 border-b-2 pb-4 border-white">
                        <div class="flex flex-col justify-center">
                            <h3 class="font-car font-medium text-4xl">1000 + </h3>
            ...
            <div class="mx-auto max-w-screen-xl ">
                ...
                <div class="mt-7 mb-16">
                    <p class="text-justify md:mx-0 mx-8 leading-relaxed text-lg md:text-l">
                        Your satisfaction is our top priority, and we are committed to providing a seamless car 
                        rental experience. With our diverse selection of well-maintained vehicles, competitive pricing, 
                        and easy booking process, we are dedicated to meeting all your travel needs. Our customer service 
                        team is available around the clock to offer support, ensuring that you enjoy exceptional service 
                        from start to finish. Whether you're planning a weekend getaway or a long road trip, choose us for 
